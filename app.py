...
st.markdown(
    ...
    <style>
        ...
        .block-container {
            ...
            background-color:rgb(88, 240, 131);  /* Slightly lighter shade for contrast */
            box-shadow: 0 4px 15px rgba(0, 0, 0, 0.3);  /* Adds subtle shadow for depth */
        }
        h1, h2, h3, h4, h5, h6 {
            color:rgb(160, 103, 33);  /* Light blue color for headings to stand out */
        }
        .stButton>button {
            border: none;
            border-radius: 8px;  /* Rounds button edges */
            background-color:rgb(74, 105, 190);  /* Primary blue for buttons */
        ...
        .stButton>button:hover {
            background-color:rgb(40, 57, 143);
            color:white;  /* Darker blue on hover for visual feedback */
            cursor: pointer;
        }
        .stDataFrame, .stTable {
